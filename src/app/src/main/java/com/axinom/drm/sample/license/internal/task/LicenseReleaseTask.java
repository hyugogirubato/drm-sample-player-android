...
public class LicenseReleaseTask extends AsyncTask<LicenseReleaseTask.Params, Void, Void> {
    ...
    public interface ILicenseReleaseTaskCallback {
        ...
        void onLicenseReleaseFailed(LicenseManagerErrorCode errorCode, String errorExtraData, String manifestUrl);
    ...
    protected Void doInBackground(Params... params) {
        ...
        if (mAllLicenseRelease) {
            Log.d(TAG, "Releasing all licenses. Has license server URL: " + !TextUtils.isEmpty(licenseServerUrl));
            ...
            Log.d(TAG, "Releasing one license. Has license server URL: " + !TextUtils.isEmpty(licenseServerUrl));
    ...
    @RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN_MR2)
    private void releaseLicenseFromServer(String defaultPath, String manifestUrl, String licenseServerUrl, Map<String, String> requestProperties) throws NotProvisionedException, UnsupportedSchemeException, ResourceBusyException, LicenseManagerException, IOException, DeniedByServerException {
        ...
        MediaDrm.KeyRequest keyRequest = mMediaDrm.getKeyRequest(keySetId, null, null, MediaDrm.KEY_TYPE_RELEASE, null);
        ...
        byte[] response = RequestUtils.executePost(licenseServerUrl, null, keyRequest.getData(), requestProperties);

        if (response == null || response.length == 0) {
            throw new LicenseManagerException(LicenseManagerErrorCode.ERROR_302, "Server response is empty");
        }
    ...
    public static class Params {
        ...
        public Params(String licenseServerUrl, String manifestUrl, String defaultStoragePath, boolean deleteAll, boolean stopOnLicenseServerFail, Map<String, String> requestProperties) {
