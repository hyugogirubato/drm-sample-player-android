...
public class LicenceDownloadTask extends AsyncTask<LicenceDownloadTask.Params, Void, byte[]> {
    ...
    @TargetApi(Build.VERSION_CODES.JELLY_BEAN_MR2)
    private byte[] getKeySetId(Params params) throws NotProvisionedException, UnsupportedSchemeException, ResourceBusyException, IOException, XmlPullParserException, DeniedByServerException, LicenseManagerException {
        ...
        if (schemeData == null) {
            throw new LicenseManagerException(LicenseManagerErrorCode.ERROR_301, "schemeData is null");
        }
        ...
        if (initData == null) {
            throw new LicenseManagerException(LicenseManagerErrorCode.ERROR_301, "DRM initData is null");
        }

        // Get request data from MediaDrm needed to be sent to License Server
        MediaDrm.KeyRequest keyRequest = mMediaDrm.getKeyRequest(mSessionId, initData, mimeType, MediaDrm.KEY_TYPE_OFFLINE, null);
        ...
        byte[] response = RequestUtils.executePost(licenseServerUrl, axDrmMessage, keyRequest.getData(), requestProperties);
        ...
        if (keySetId == null || keySetId.length == 0) {
            ...
            throw new LicenseManagerException(LicenseManagerErrorCode.ERROR_302, "keySetId is empty");
        }
    ...
    public static class Params {
        ...
        public Params(Map<String, String> requestProperties, String manifestUrl, String licenseServerUrl, String axDrmMessage, String defaultStoragePath, long minExpireSecond) {
