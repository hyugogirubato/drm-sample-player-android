...
public class OfflineLicenseManager {
    ...
    public OfflineLicenseManager(Context context) {
        ...
        Log.d(TAG, "Initializing OfflineLicenseManager, " + "setting value to mDefaultStoragePath = [" + mDefaultStoragePath + "]");
    }
    ...
    public void getLicenseKeys(String manifestUrl) {
        cancelRestoreTask();
        LicenseRestoreTask.Params params = new LicenseRestoreTask.Params(manifestUrl, mDefaultStoragePath, mMinExpireSeconds);
    ...
    public void releaseLicense(String manifestUrl) {
        LicenseReleaseTask.Params params = new LicenseReleaseTask.Params(null, manifestUrl, mDefaultStoragePath, false, false, mRequestParams);
    ...
    public void releaseLicense(String manifestUrl, String licenseServerUrl, boolean stopOnLicenseServerFail) {
        LicenseReleaseTask.Params params = new LicenseReleaseTask.Params(licenseServerUrl, manifestUrl, mDefaultStoragePath, false, stopOnLicenseServerFail, mRequestParams);
        runReleaseLicenseTask(params);
    }
    ...
    public void releaseAllLicenses(String licenseServerUrl, boolean stopOnLicenseServerFail) {
        LicenseReleaseTask.Params params = new LicenseReleaseTask.Params(licenseServerUrl, null, mDefaultStoragePath, true, stopOnLicenseServerFail, mRequestParams);
        runReleaseLicenseTask(params);
    }
    ...
    public void releaseAllLicenses() {
        LicenseReleaseTask.Params params = new LicenseReleaseTask.Params(null, null, mDefaultStoragePath, true, false, mRequestParams);
        runReleaseLicenseTask(params);
    }
    ...
    public void checkLicenseValid(String manifestUrl) {
        cancelCheckTask();
        LicenseCheckTask.Params params = new LicenseCheckTask.Params(manifestUrl, mDefaultStoragePath, mMinExpireSeconds);
    ...
    public void checkLicenseValidWithKeys(String manifestUrl, byte[] keyIds) {
        cancelCheckTask();
        LicenseCheckTask.Params params = new LicenseCheckTask.Params(manifestUrl, mDefaultStoragePath, mMinExpireSeconds, keyIds);
        mCheckTask = new LicenseCheckTask(mInternalListener);
        mCheckTask.execute(params);
    }
    ...
    public void downloadLicenseWithResult(String licenseServerUrl, String manifestUrl, String drmMessage, boolean autoSave) {
        cancelDownloadTask();
        LicenceDownloadTask.Params params = new LicenceDownloadTask.Params(mRequestParams, manifestUrl, licenseServerUrl, drmMessage, mDefaultStoragePath, mMinExpireSeconds);
    ...
    private class InternalListener implements LicenceDownloadTask.ILicenceDownloadTaskCallback, LicenseCheckTask.ILicenceCheckTaskCallback, LicenseReleaseTask.ILicenseReleaseTaskCallback, LicenseRestoreTask.ILicenceRestoreTaskCallback {
