...
public class LicenseCheckTask extends AsyncTask<LicenseCheckTask.Params, Void, Boolean> {
    ...
    protected Boolean doInBackground(Params... params) {
        ...
        try {
            ...
            byte[] offlineLicenseKeySetId = savedKeys == null ? LicenseFileUtils.readLicenseFile(params[0].defaultStoragePath, mManifestUrl) : savedKeys;
    ...
    public static class Params {
        ...
        public Params(String manifestUrl, String defaultStoragePath, long minExpireSecond, byte[] savedKeys) {
