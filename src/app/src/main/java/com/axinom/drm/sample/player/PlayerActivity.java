...
public class PlayerActivity extends Activity implements DemoPlayer.Listener, View.OnClickListener {
    ...
    private void handleIntent(Intent intent) {
        ...
        if (intent.hasExtra(DRM_SCHEME)) {
            ...
            drmConfigurationBuilder.setLicenseUri(intent.getStringExtra(WIDEVINE_LICENSE_SERVER));
    ...
    public void onPlayerError(Exception e) {
        ...
        if (e instanceof UnsupportedDrmException) {
            ...
            errorString = getString(unsupportedDrmException.reason == UnsupportedDrmException.REASON_UNSUPPORTED_SCHEME ? R.string.error_drm_unsupported_scheme : R.string.error_drm_unknown);
        } else if (e instanceof ExoPlaybackException && e.getCause() instanceof MediaCodecRenderer.DecoderInitializationException) {
            // Special case for decoder initialization failures.
            MediaCodecRenderer.DecoderInitializationException decoderInitializationException = (MediaCodecRenderer.DecoderInitializationException) e.getCause();
    ...
    private void showAlertDialog(String message) {
        ...
        alertDialogBuilder.setMessage(message).setCancelable(false).setPositiveButton("OK", (dialog, id) -> finish());
    ...
    public void onClick(View view) {
        if (view.getId() == mConsoleButton.getId()) {
            ...
            if (clipboardManager != null) {
                ClipData clipData = ClipData.newPlainText("DRM Sample Player console", mConsoleOutputText.getText());
