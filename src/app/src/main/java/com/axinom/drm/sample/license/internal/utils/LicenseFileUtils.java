...
public class LicenseFileUtils {
    ...
    public static void writeLicenseFile(String defaultStoragePath, String manifestUrl, byte[] offlineLicenseKeySetId) throws LicenseManagerException {
        String licenseFileName = getBase64Name(manifestUrl);
        if (TextUtils.isEmpty(licenseFileName)) {
            throw new LicenseManagerException(LicenseManagerErrorCode.ERROR_303, "Problem while saving keys. Incorrect manifest name: " + manifestUrl);
        }
        ...
        if (!canContinue) {
            throw new LicenseManagerException(LicenseManagerErrorCode.ERROR_303, "Problem while saving keys. Cannot create folder for licenses.");
        }
        if (licenseFile.exists()) canContinue = licenseFile.delete();
        if (!canContinue) {
            throw new LicenseManagerException(LicenseManagerErrorCode.ERROR_303, "Problem while saving keys. Cannot delete old license.");
        }
        try {
        ...
        if (!canContinue) {
            throw new LicenseManagerException(LicenseManagerErrorCode.ERROR_303, "Problem while saving keys. Cannot create new file for license.");
        }
    ...
    public static void deleteLicenseFile(String defaultStoragePath, String manifestUrl) throws LicenseManagerException {
        String licenseFileName = getBase64Name(manifestUrl);
        if (TextUtils.isEmpty(licenseFileName)) {
            throw new LicenseManagerException(LicenseManagerErrorCode.ERROR_303, "Problem deleting saving keys. Incorrect manifest name: " + manifestUrl);
        }
        ...
        if (licenseFile.exists()) canContinue = licenseFile.delete();
        if (!canContinue) {
            throw new LicenseManagerException(LicenseManagerErrorCode.ERROR_303, "Problem deleting saving keys. Cannot delete license file.");
        }
    }
    ...
    public static void deleteAllLicenses(String defaultStoragePath) throws LicenseManagerException {
        ...
        if (!canContinue) {
            throw new LicenseManagerException(LicenseManagerErrorCode.ERROR_303, "Problem deleting all keys. Cannot delete licenses folder.");
        }
    }
    ...
    public static byte[] readLicenseFile(String defaultStoragePath, String manifestUrl) throws LicenseManagerException {
        ...
        String licenseFileName = getBase64Name(manifestUrl);
        if (TextUtils.isEmpty(licenseFileName)) {
            throw new LicenseManagerException(LicenseManagerErrorCode.ERROR_303, "Problem while reading keys. Incorrect manifest name: " + manifestUrl);
        }

        File licenseFile = getFileFromDataFolder(defaultStoragePath, licenseFileName);
        if (!licenseFile.exists()) {
            throw new LicenseManagerException(LicenseManagerErrorCode.ERROR_303, "Problem while reading keys. Keys do not exists.");
        }
