...
public class RequestUtils {
    ...
    public static byte[] getManifest(String path, Map<String, String> requestProperties) throws IOException {
    ...
    public static byte[] executePost(String url, String drmMessage, byte[] data, Map<String, String> requestProperties) throws IOException {
